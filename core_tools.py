...
TOOLS = {
    ...
    "synthesize_evolutions":  {"fn": t_synthesize_evolutions,  "perm": "WRITE",   "args": [],
                                 "desc": "Groq acts as CORE's unconstrained architect. Reads: pending evolution_queue, top pattern_frequency, recent cold_reflections, hot_reflection gaps, open task_queue. Groq thinks 6 months ahead and generates 3-8 new engineering tasks. Tasks inserted into task_queue (source=core_v6_registry) -- NOT SESSION.md. Evolutions marked synthesized. Telegram notify sent. Returns tasks_created + task_titles. Manual trigger only."},
