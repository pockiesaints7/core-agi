...
_FUZZY_INTENT_CLUSTERS: list[tuple[str, bool, set[str]]] = [
    ...
    ("system_state",     True,  {"verify current git commit", "verify the current git commit", "git status",
                                  "sync with github", "synced with github", "current git commit",
                                  "repo cleanliness", "repository cleanliness", "cleanliness of core-agi",
                                  "current commit", "commit and cleanliness"}),
    ("owner_review",     True,  {"owner-review cluster packet", "owner review cluster packet", "owner-review cluster",
                                  "owner review cluster", "cluster packet", "batch-close cluster",
                                  "batch close cluster", "owner_review_cluster_packet",
