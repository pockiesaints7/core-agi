...
## Current Step: TASK-15: SESSION.md slim — remove dead Section 6 (task registry) and Section 7 (session log), remove checkbox-ticking code from t_session_end. Then TASK-10.B: Project Indexer.
