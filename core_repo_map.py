...
from core_config import SUPABASE_PAT, SUPABASE_REF, SUPABASE_URL, _sbh_count_svc, sb_get, sb_patch, sb_post, sb_upsert
...
REPO_MAP_INTERVAL_S = max(300, int(os.getenv("CORE_REPO_MAP_INTERVAL_S", "1800")))
REPO_MAP_BATCH_LIMIT = max(1, int(os.getenv("CORE_REPO_MAP_BATCH_LIMIT", "400")))
