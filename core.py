    ...
    while True:
        try:
            ...
            if should_run:
                ...
                pass  # Supabase is source of truth — no GitHub commit needed
...
TOOLS = {
    ...
    "list_suggestions":       {"fn": t_list_suggestions,       "perm": "READ",    "args": ["status", "limit"],
                               "desc": "List Groq improvement suggestions. status=pending_review|approved|dismissed"},
    "action_suggestion":      {"fn": t_action_suggestion,      "perm": "WRITE",   "args": ["suggestion_id", "action", "notes"],
                               "desc": "Act on a suggestion: approve (→ Claude Desktop), dismiss, or convert_to_kb"},
